...
**Source:** NIST AI 100-1 Playbook (January 2023)

**Note:** Voluntary framework for AI risk management
...
**About:** AI systems may be subject to specific applicable legal and regulatory requirements. Some
...
are not applied uniformly within the legal context. Disparate i
...
**Documentation Guidance:** Organizations can document the following
...
**About:** Policies, processes, and procedures are central components of effective AI risk management
...
lifecycle. Without such policies, risk management
...
**About:** Risk management resources are finite in any organization. Adequate AI governance policies
...
risks that can result in irredeema
...
• How do the entity’s data security and privacy assessments info
...
**About:** Clear policies and procedures relating to documentation and transparency facilitate and
...
document, AI actors can improve communication, increase ownership of work produc
...
in the design, development, deployment, asse
...
**About:** AI systems are dynamic and may perform in unexpected ways once deployed or after
...
in deploying the identified AI solution (e.g. personnel risk or cha
...
**About:** An AI system inventory is an organized database of artifacts relating to an AI system or
...
view of organizational AI assets. A serviceable AI system inventory ma
...
**About:** Irregular or indiscriminate termination or deletion of models or AI systems may be
...
community concerns, risks in dependent and
...
**About:** The development of a risk-aware organizational culture starts with defining
...
intended uses and limitations of the analyti
...
**About:** To enhance AI risk management adoption and effectiveness, organizations are encouraged
...
**About:** Senior leadership and members of the C-Suite in organizations that maintain an AI portfolio,
...
**About:** A diverse team that includes AI actors with diversity of experience, disciplines, and
...
recommended that teams are composed of 
...
- Define policies and hiring practices at the outset that promote interdisciplinary roles, competencies, skills, and capacity for AI efforts. Define policies and hiring practices that lead to demographic and domain expertise diversity; empower staff with necessary resources and support, and facilitate the contribution of staff feedback and concerns without fear of reprisal. Establish policies that facilitate inclusivity and the integration of new insights into existing practice. Seek external expertise to supplement organizational diversity, equity, inclusion, and accessibility where internal expertise is lacking. Establish policies that incentivize AI actors to collaborate with existing nondiscrimination, accessibility and accommodation, and human resource functions, employee resource group (ERGs), and diversity, equity, inclusion, and accessibility (DEIA) initiatives.
...
**About:** Identifying and managing AI risks and impacts are enhanced when a broad set of
...
• To what extent has the entity docume
...
**About:** A risk culture and accompanying practices can help organizations effectively triage the most
...
cultivating a strong risk culture through other means. For e
...
**About:** Impact assessments are one approach for driving responsible technology development
...
be applied at the beginning of 
...
origins, transformations, augmentations,
...
**About:** Identifying AI system limitations, detecting and tracking negative impacts and incidents,
...
manage such issues. Efforts can take the form of
...
stages of development to ensure there is transparency on the technolog
...
**About:** Beyond internal and laboratory-based system testing, organizational policies and practices
...
emergent scenarios and risks in certain AI applications. 
...
AI system to external stakeholders, including end users, consumers, regulators, and
individuals impacted by use of the AI system?
• To what extent has the entity clarif
...
**About:** Organizational policies and procedures that equip AI actors with the processes, knowledge,
...
When risks arise, resources are allocate
...
**About:** Risk measurement and management can be complicated by how customers use or integrate
...
the AI lifecycle. This engagement has beneficial uses and can increase complexities of ris
...
**About:** To mitigate the potential harms of third-party system failures, organizations may
...
**About:** AI systems may not necessarily be the right solution for a given business task or problem. A
...
**About:** Risk refers to the composite measure of an event’s probability of occurring and the
...
requirements. Since risk management resources 
...
objectives)?
• What assessments has the entity conducted on data security and privacy im
...
**About:** Outcomes from GOVERN-1, MAP-5 and MEASURE-2, can be used to address and document
...
accepted model risk management, enterprise risk management, and inform
...
**About:** Organizations may choose to accept or transfer some of the documented risks from MAP
...
• Who will be responsible for maintaining, re-verifying, monitoring, and updating t
...
**About:** Organizational risk response may entail identifying and analyzing alternative approaches,
...
**About:** System performance and trustworthiness may evolve and shift over time, once an AI system
...
once deployed. Processes and mechanisms for regular moni
...
**About:** AI systems – like any technology – can demonstrate non-functionality or failure or
...
processes clearly defined? (Including responsibilities to decommission t
...
**About:** Performance inconsistent with intended use does not always increase risk or lead to
...
detected or identified risks exceed tolerance thresh
...
• What are the roles, responsibilities, and delegation of authorities of personnel involved
in the design, development, deployment, assessment and monitoring of the AI system?
• Did your organization implement a risk management system to address risks involve
...
**About:** AI systems may depend on external resources and associated processes, including thirdparty data, software or hardware systems. Third parties’ supplying organizations with
...
and resources that were employed can help manage risks. 
...
If your organization obtained datasets from a third party, did your organizatio
...
**About:** A common approach in AI development is transfer learning, whereby an existing pretrained model is adapted for use in a different, but related application. AI actors in
...
are typically trained to address various classification or p
...
metadata?
• Does this dataset collection/processing procedure achieve the motivation for creati
...
**About:** AI system performance and trustworthiness can change due to a variety of factors. Regular
...
feedback about system performance, limitations, and impacts, 
...
**About:** Regularly documenting an accurate and transparent account of identified and reported
...
community of stakeholders? How easily a
...
**About:** Highly accurate and optimized systems can cause harm. Relatedly, organizations should
...
**About:** Successfully mapping context requires a team of AI actors with a diversity of experience,
...
managing AI risks is not the beliefs or presumed bel
...
**About:** Defining and documenting the specific business purpose of an AI system in a broader
...
**About:** Socio-technical AI risks emerge from the interplay between technical development
...
system design, development, and deployment tasks that may res
...
**About:** Risk tolerance reflects the level and type of risk the organization is willing to accept while
...
tolerances?
• How has the entity identified maxim
...
**About:** AI system development requirements may outpace documentation processes for traditional
...
early in the design phase is a priority that can en
...
AI system to external stakeholders, including end users, consumers, regulators, and
individuals impacted by use of the AI system?
• To what extent is this information s
...
**About:** AI actors define the technical learning or decision-making task(s) an AI system is designed
...
**About:** An AI lifecycle consists of many interdependent activities involving a diverse set of actors
...
of an AI system can alter its behavio
...
• What type of information is accessible on the design, operations, and limitations of the
AI system to external stakeholder
...
**About:** Standard testing and evaluation protocols provide a basis to confirm assurance in a system
...
and evaluation methodologies and metrics therefore addr
...
**About:** AI systems have enormous potential to improve quality of life, enhance economic prosperity
...
communities. These stakeholders can provide
...
**About:** Anticipating negative impacts of AI systems is a difficult task. Negative impacts can be due
...
- Who could be harmed? What could be harmed? When could harm arise? How could harm arise?
...
• To what extent can users or parties affected by the outputs of the AI system test the AI
system and provide feedback?
• Have you documented and explai
...
**About:** Systems that function in a narrow scope tend to enable better mapping, measurement, and
...
and manage due to the variability from both 
...
**About:** Human-AI configurations can span from fully autonomous to fully manual. AI systems can
...
system, the expert may interact with the AI system but is ra
...
either an adversary’s attempts to disrupt the
...
**About:** As AI systems have evolved in accuracy and precision, computational systems have moved
...
**About:** Technologies and personnel from third-parties are another potential sources of risk to
...
unanticipated effects along with possible introduction of increased levels 
...
- Inventory third-party material (hardware, open-source software, foundation models, open source data, proprietary software, proprietary data, etc.) required for system implementation and maintenance. Review redundancies related to third-party technology and personnel to assess potential risks due to lack of adequate support.
...
**About:** In the course of their work, AI actors often utilize open-source, or otherwise freely
...
**About:** AI actors can evaluate, document and triage the likelihood of AI system impacts identified in
...
• Can the AI system be tested by independent third par
...
**About:** AI systems are socio-technical in nature and can have positive, neutral, or negative
...
**About:** The development and utility of trustworthy AI systems depends on reliable measurements
...
influenced by societal dynamics and human behavior. AI risks – and benefits – 
...
**About:** Different AI tasks, such as neural networks or natural language processing, benefit from
...
**About:** The current AI systems are brittle, the failure modes are not well described, and the systems
...
there are potentially significant costs can improv
...
• What are the roles, responsibilities, and delegation of authorities of personnel involved
in the design, development, deployment, assessment and monitoring of the AI system?
• How easily accessible and current is the information available to external stakeh
...
**About:** Documenting measurement approaches, test sets, metrics, processes and materials used,
...
**About:** Measurement and evaluation of AI systems often involves testing with human subjects or
...
completion of mandatory training regardi
...
How has the entity identified and mitigated potential impacts
...
**About:** The current risk and impact environment suggests AI system performance estimates are
...
on an approximation of expected AI use. To properly manage risks, more d
...
**About:** AI systems may encounter new issues and risks while in production as the environment
...
**About:** An AI system that is not validated or that fails validation may be inaccurate or unreliable or
...
Validation risks include the use of proxies or other indicators that are o
...
**About:** Many AI systems are being introduced into settings such as transportation, manufacturing
...
Measuring activities for safety often relate to exhaustive 
...
limitations (i.e.adversarial or stress testing)?
• To what extent has the entity documented the AI system’s development, testing
methodology, metrics, and performance out
...
**About:** AI systems, as well as the ecosystems in which they are deployed, may be said to be resilient
...
models, training data, or other intellectual property
...
**About:** Transparency enables meaningful visibility into entire AI pipelines, workflows, processes or
...
impacted communities to seek redress for incorrect
...
**About:** Explainability and interpretability assist those operating or overseeing an AI system, as well
...
• Given the purpose of this AI, what is an appropriate interval for checking whether it is
still accurate, unbiased, explainable
...
**About:** Privacy refers generally to the norms and practices that help to safeguard human autonomy,
...
- Quantify privacy-level data aspects such as the ability to identify individuals or groups (e.g. k-anonymity metrics, l-diversity, t-closeness). Establish and document protocols (authorization, duration, type) and access controls for training sets or production data containing personally sensitive information, in accordance with privacy and data governance policies. Monitor internal queries to production data for detecting patterns that isolate personal records. Monitor PSI disclosures and inference of sensitive or legally protected attributes

- Assess the risk of manipulation from overly customized content. Evaluate information presented to representative users at various points along axes of difference between individuals (e.g. individuals of different ages, genders, races, political affiliation, etc.). Use privacy-enhancing techniques such as differential privacy, when publicly sharing dataset information. Collaborate with privacy experts, AI end users and operators, and other domain experts to determine optimal differential privacy metrics within contexts of use.
...
**About:** Fairness in AI includes concerns for equality and equity by addressing issues such as
...
necessarily fair. For example, systems in which predictions are so
...
- Identify types of harms, including allocational, representational, quality of service, stereotyping, or erasure Identify across, within, and intersecting groups that might be harmed

- Quantify harms using both a general fairness metric, if appropriate (e.g. demographic parity, equalized odds, equal opportunity, statistical hypothesis tests), and custom, context-specific metrics developed in collaboration with affected communities Analyze quantified harms for contextually significant differences across groups, within groups, and among intersecting groups Refine identification of within-group and intersectional group disparities.
...
group? In what ways? How was this m
...
**About:** Large-scale, high-performance computational resources used by AI systems for training and
...
**About:** The development of metrics is a process often considered to be objective but, as a human
...
Revisiting the metrics chosen in Measure 2.1 through 2.12 in a process of c
...
goals and objectives?
• Given the purpose of this AI, what is an appropriate interval for checking whether it is
still accurate, unbiased, explainable, etc.? What are the che
...
**About:** For trustworthy AI systems, regular system monitoring is carried out in accordance with
...
support AI actors as they investigate and resp
...
- Compare end user and community feedback about deployed AI systems to internal measures of system performance. Assess effectiveness of metrics for identifying and measuring emergent risks. Measure error response times and track response quality. Elicit and track feedback from AI actors in user support roles about the type of metrics, explanations and other system information required for fulsome resolution of system issues. Consider:

- simpler or traditional models human baseline performance other manual performance benchmarks Instances where explanations are insufficient for investigating possible error sources or identifying responses. System metrics, including system logs and explanations, for identifying and diagnosing sources of system error. Elicit and track feedback from AI actors in incident response and support roles about the adequacy of staffing and resources to perform their duties in an effective and timely manner.
...
in deploying the identified AI solution (e.g. personnel risk or changes to commercial
objectives)?
• To what extent can users or parties affected by the outputs of the AI sys
...
**About:** Risks identified in the Map function may be complex, emerge over time, or difficult to
...
- Recourse mechanisms for faulty AI system outputs. Bug bounties. Human-centered design approaches. User-interaction and experience research. Participatory stakeholder engagement with affected or potentially impacted individuals and communities. Identify AI actors responsible for tracking emergent risks and inventory methods. Determine and document the rate of occurrence and severity level for complex or difficult-to-measure risks when:

- Prioritizing new measurement approaches for deployment tasks. Allocating AI system risk management resources. Evaluating AI system improvements. Making go/no-go decisions for subsequent system iterations.
...
**About:** Assessing impact is a two-way effort. Many AI system outcomes and impacts may not be
...
Metrics and insights developed in this sub-catego
...
**About:** AI Actors carrying out TEVV tasks may have difficulty evaluating impacts within the system
...
Activities described in the Measure function enable AI actors to evaluat
...
**About:** Feedback captured from relevant AI Actors can be evaluated in combination with output
...
potential misuse or reuse outside of intended set
...
**About:** TEVV activities conducted throughout the AI system lifecycle can provide baseline
...
elicitation about AI systems’ impacts. These sources of information can allow AI act
